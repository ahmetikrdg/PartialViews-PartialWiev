...
namespace shopapp.webui.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult list()
        {
           ...
           new Product{Name="Iphone 10", Price=6000,Description="Güzel telefon"}
            ...
            var categories = new List<Category>(){
                new Category { Name = "Telefon", Description = "Telefon kateogrisi" },
                new Category { Name = "Bilgisayar", Description = "Bilgisyar kateogrisi" },
                new Category { Name = "Elektronik", Description = "Elektronik kateogrisi" }
        };
        ...
        {
            Categories = categories, //burada oluşturduğum category ve productu productview modele gönderdim
            Products = product
        };
